...
1. Generate your design in Mattercontrol, and export it an .STL file. (The user combines and subtracts basic shapes to create the needed design. It is a simple bt versatile GUI, but not a coding studio or intense graphical program.)
